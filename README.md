...
| H3-Sol | `services/vedio-minimax-h3-sol` | Sol 常驻双 rank 推理服务，版本 `vedio-minimax-h3-sol-v0.2.0`；上线结果见中央验收记录 |
| MCP | `services/vedio-mcp-server` | 统一调用入口及 Dashboard，版本 `vedio-mcp-server-v0.4.0`（上线证据以中央发布记录为准） |
